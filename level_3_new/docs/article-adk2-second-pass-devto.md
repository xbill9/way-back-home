...
- Technical claims were verified against `google-adk` 2.6.3 / `google-genai` 2.17.0 in `level_3_new` on 2026-08-12, with the `level_3` and `level_3_gemini` comparisons taken from the same repo.
