...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-env-vars="GOOGLE_CLOUD_PROJECT=${PROJECT_ID},GOOGLE_CLOUD_LOCATION=${REGION},GOOGLE_GENAI_USE_VERTEXAI=False,MODEL_ID=models/walkie-talkie,ALLOWED_ORIGINS=${ALLOWED_ORIGINS}" \
